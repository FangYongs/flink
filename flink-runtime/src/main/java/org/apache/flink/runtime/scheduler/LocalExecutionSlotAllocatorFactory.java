...
/** Factory for {@link LocalExecutionSlotAllocator}. */
public class LocalExecutionSlotAllocatorFactory implements ExecutionSlotAllocatorFactory {
    ...
    public LocalExecutionSlotAllocatorFactory(
    ...
    public ExecutionSlotAllocator createInstance(ExecutionSlotAllocationContext context) {
        return new LocalExecutionSlotAllocator(
                physicalSlotProvider,
                context.getTaskManagers(),
                taskManagerSelectionStrategy,
                jobTaskManagerCounter,
                context.getJobMasterId());
    }
}
